# Sobrius: Seu Caminho Personalizado para a Liberdade Duradoura da Dependência
...
| ----- | ----- |
| O sistema deve permitir o cadastro de usuários | Sim | 
| O sistema deve permitir o cadastro com conta Google | Sim | 
| O usuário deve poder selecionar qual vício deseja se livrar | Sim |
| O usuário deve conseguir visualizar um calendário com o histórico de recaídas | Sim |
| O usuário deve conseguir visualizar timer referente ao tempo livre do vício | Sim | 
| O usuário deve conseguir cadastrar suas recaídas | Sim | 
| O usuário deve poder cadastrar um motivo pessoal para parar com seu vício | Sim | 
| O sistema deve gerar relatórios e gráficos para analisar seu progresso e suas recaídas | Sim | 
| O usuário poderá adicionar uma foto ao seu perfil | Sim | 
| O usuário poderá adicionar uma breve descrição ao seu perfil | Sim | 

## 💻 Como rodar
1. Abra o código no Android Studio ou outro compilador que tenha apoio para Flutter.
2. Abra um terminal e execute os seguintes comandos: flutter update, flutter pub get, flutter outdated.
3. Abra uma instância de telefone (Ex.: Emulador do Android Studio).
4. Execute o código
